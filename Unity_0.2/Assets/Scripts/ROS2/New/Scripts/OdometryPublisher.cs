...
// في ArticulationBody نستخدم velocity للحركة الخطية و angularVelocity للزاوية
	var linRos = ab.velocity.To<FLU>();
	var angRos = ab.angularVelocity.To<FLU>();
