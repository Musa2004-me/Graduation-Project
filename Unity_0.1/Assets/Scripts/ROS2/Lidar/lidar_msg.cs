...
public class LidarROS2Publisher : MonoBehaviour
{
    ...
    void PublishLaserScan()
    {
        ...
        // مزامنة دقيقة مع ساعة السيستم الحقيقية متوافقة مع الـ TF بالملي ثانية
        System.DateTimeOffset now = System.DateTimeOffset.UtcNow;
        scan.header.stamp.sec = (int)now.ToUnixTimeSeconds();
        scan.header.stamp.nanosec = (uint)(now.Millisecond * 1_000_000);
